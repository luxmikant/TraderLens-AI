...
![Tradl AI architecture diagram](diagram-export-12-4-2025-9_47_50-PM.png)

This diagram summarizes the multi-agent LangGraph pipeline described in `docs/ARCHITECTURE.md`, encompassing ingestion, deduplication, NER, impact scoring, sentiment analysis, and storage/query agents.
